...
import com.example.loginpage.Models.FirebaseMessageModel;
import com.example.loginpage.Models.FirebaseUserModel;
import com.example.loginpage.Models.MessageCell;
                        ...
                        public void onComplete(DatabaseError databaseError, DatabaseReference databaseReference) {
                            ...
                            if (databaseError != null) {
                                ...
                                if (registration_ids.length() > 0) {
                                    ...
                                    client.addHeader(HttpHeaders.AUTHORIZATION, "AAAAq7UnAto:APA91bEkFn6uJ4ExfYgX6gnYAe_nKWwjhIi-tpAnex2pxbueK6gOE7pxz4XcQnMEMqB30b37QvLP-9-cEEWxOgETLfxwSImDPOpYhkf_xDgFy6ehfghpA-uS8Kkdosgrfup1c4Ry8Ikr");
